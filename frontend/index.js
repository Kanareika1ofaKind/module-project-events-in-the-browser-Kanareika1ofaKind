...
function moduleProject2() {
  ...
  // console.log(startTime);  --> Проверка
  ...
  for (let n = 0; n < 5; n++) {
    ...
    for (let m = 0; m < 5; m++) {
      ...
      square.addEventListener('click', () => {
        ...
        // console.log('you clicked');  // --> Проверка
        //  console.log(square);
        // console.log(square.classList.contains('square'));
...
if (isUp) {
  ...
  if (mosquito && mosquito.dataset.status === 'alive') {
    ...
    if (!liveMosquitoes.length) {
      ...
      document.querySelector('p.info').textContent = `Extermination complete in ${elapsed / 1000} seconds!`
